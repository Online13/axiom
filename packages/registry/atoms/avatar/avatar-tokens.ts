...
type AvatarStatusColors = { online: string; away: string; busy: string; offline: string };
...
export const avatarTokens = (colors: ThemeColors): AvatarTokens => ({
  default: {
    default: { background: colors.border.default, foreground: colors.content.muted, ring: colors.background.default },
  },
  status: {
    default: {
