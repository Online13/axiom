...
type MenuColors = { background: string; item?: string; separator: string; foreground: string };
...
export const menuTokens = (colors: ThemeColors): MenuTokens => ({
  default: {
    default: { background: colors.background.elevated, separator: colors.background.subtle, foreground: colors.content.default },
