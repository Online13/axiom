...
export type FloatingButtonProps = Omit<TappableProps, 'children' | 'style' | 'accessibilityLabel'> &
...
export function FloatingButton({
  ...
  const dimension = size === 'sm' ? tokens.sizes.control.md : tokens.sizes.control.lg;

  return (
    <Animated.View style={[styles.anchor, position, hidden && styles.passThrough, animatedStyle]}>
      <Tappable
        {...props}
