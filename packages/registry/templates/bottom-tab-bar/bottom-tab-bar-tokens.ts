...
export const bottomTabBarTokens = (colors: ThemeColors): BottomTabBarTokens => ({
  fixed: {
    default: { background: colors.background.default, border: colors.border.subtle },
  },
  floating: {
    default: { background: colors.background.elevated, border: colors.border.subtle },
  },
  item: {
