...
type AttachmentStates = States<AttachmentColors, 'uploading' | 'done' | 'error'>;
...
export const attachmentTokens = (colors: ThemeColors): AttachmentTokens => ({
  row: {
    ...
    error: { border: colors.feedback.error, meta: colors.feedback.error, icon: colors.feedback.error },
  },
  tile: {
