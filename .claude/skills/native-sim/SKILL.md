...
unrelated files. The `--agent` option is optional and requires `agent-device`;
the browser simulator works without it.

## Quick start for a standalone Expo repository
...
See the upstream [reference](https://github.com/bidah/native-sim/blob/main/.claude/skills/native-sim/REFERENCE.md)
for architecture, measured data, and troubleshooting, and the
[connection guide](https://github.com/bidah/native-sim/blob/main/docs/how-the-connection-works.md)
for how the stream reaches the browser. The
[prebuilt app guide](https://github.com/bidah/native-sim/blob/main/docs/prebuilt-app-flow.md)
covers a repo with no app source.
