...
export function CatalogGroup({ title, children }: { title: string; children: ReactNode }) {
...
export function CatalogRow({ href, title, description, badge, divider = true }: CatalogRowProps) {
