...
export default function BottomTabBarScreen() {
	...
	return (
		<Screen>
			<Section
				title="BottomTabBar"
				description="Three to five destinations, with a badge for new content."
			>
				<Panel>
			...
			<Section
				title="Floating"
				description="An inset pill instead of a bar pinned to the edge."
			>
				<Frame>
					<BottomTabBar
						safeArea={false}
