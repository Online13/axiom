...
const EXAMPLES = {
  ...
  badge: { Component: BadgeExamples, titles: ['Badge', 'Counter on an anchor'] },
  ...
  checkbox: { Component: CheckboxExamples, titles: ['Checkbox', 'Select all'] },
  radio: { Component: CheckboxExamples, titles: ['Radio', 'Horizontal and custom rows'] },
  'date-picker': {
  ...
  input: { Component: InputExamples, titles: ['Login form', 'Validation on blur', 'Prefix, suffix and sizes', 'Chain fields'] },
  ...
  'segmented-control': { Component: SegmentedControlExamples, titles: ['SegmentedControl'] },
  ...
  text: { Component: TypographyExamples, titles: ['Text variants', 'Colors', 'Weight, alignment, nesting'] },
...
export default function ComponentScreen() {
  ...
  const title = SCREENS.find((screen) => screen.name === component)?.title ?? 'Component';
  ...
  return (
    <SectionScope titles={example.titles}>
      <Stack.Screen options={{ title }} />
      <example.Component />
    </SectionScope>
  );
