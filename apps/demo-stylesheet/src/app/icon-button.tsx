...
export default function IconButtonScreen() {
  ...
  return (
    <Screen>
      ...
      <Section title="Variants and sizes" description="sm is 32pt but keeps a 44pt touch area.">
        <Panel>
      ...
      <Section title="Toggles" description="selected marks a toggle as on and sets accessibilityState.selected.">
        <Panel>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: tokens.spacing[2] }}>
            ...
            <IconButton
              ...
              selected={bookmarked}
              disabled={disabled}
              accessibilityLabel={bookmarked ? 'Remove from list' : 'Add to list'}
