      ...
      >
        <Panel>
          ...
          <Row label="Close on backdrop press" description="Off: the overlay blocks the screen but ignores presses">
            <Switch value={dismissible} onValueChange={setDismissible} accessibilityLabel="Close on backdrop press" />
          </Row>
      ...
      <Portal>
        ...
        {mounted ? (
          ...
          >
            ...
            <Text color="muted">
              {dismissible ? 'Press the backdrop or the button to close.' : 'Only the button closes it.'}
            </Text>
            <Button
              fullWidth
              onPress={() => {
