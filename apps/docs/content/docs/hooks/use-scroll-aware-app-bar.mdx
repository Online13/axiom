  ...
  return (
    <View style={{ flex: 1 }}>
      <Animated.ScrollView {...bar.scrollProps}>
        ...
        <Text variant="title" {...bar.titleProps}>{article.title}</Text>
...
const background = useAnimatedStyle(() => ({
  backgroundColor: interpolateColor(bar.elevation.value, [0, 1], ['transparent', colors.background.default]),
  borderBottomColor: interpolateColor(bar.elevation.value, [0, 1], ['transparent', colors.border.default]),
}));
