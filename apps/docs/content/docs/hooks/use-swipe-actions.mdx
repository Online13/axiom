...
The hook behind [Swipe actions](/behaviors/swipe-actions) and [Swipe-to-delete](/behaviors/swipe-to-delete). Those pages explain the direction lock, the resistance, the release rules, the full swipe and accessibility. This one covers the API.
