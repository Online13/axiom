...
export const lightColors = {
  background: { default: 'hsla(0, 0%, 100%, 1)', subtle: palette.gray[50], elevated: 'hsla(0, 0%, 100%, 1)', inverse: palette.gray[950] },
...
export const darkColors = {
  background: { default: 'hsla(0, 0%, 0%, 1)', subtle: palette.gray[950], elevated: palette.gray[900], inverse: palette.gray[50] },
