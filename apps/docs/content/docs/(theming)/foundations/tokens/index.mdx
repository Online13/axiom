---
title: Introduction
description: "Raw primitive values: palette, spacing, radius, typography, sizes and metrics."
---

<Callout title="Draft">The values and key names shown in this section are conceptual and may change.</Callout>
...
<Cards>
  <Card title="Palette" href="/foundations/tokens/palette">
    Every raw color, in scales from 50 to 950.
  </Card>
  <Card title="Spacing" href="/foundations/tokens/spacing">
    Padding, margins and gaps on a 4 grid.
  </Card>
  <Card title="Radius" href="/foundations/tokens/radius">
    Corner rounding of surfaces and controls.
  </Card>
  <Card title="Typography" href="/foundations/tokens/typography">
    The type scale, from 34 down to 12.
  </Card>
  <Card title="Sizes" href="/foundations/tokens/sizes">
    Standard sizes for icons, avatars and controls.
  </Card>
  <Card title="Metrics" href="/foundations/tokens/metrics">
