...
<Callout title="Draft">Specified, not implemented yet. It relies on [Skeleton](/atoms/skeleton), [Empty](/atoms/empty) and a data library such as TanStack Query. The API may change.</Callout>
