...
<Callout title="Draft">The long press is handled by [Tappable](/core/tappable) (`onLongPress`), and the menu it opens by [Menu](/atoms/menu). Both APIs are conceptual and may change.</Callout>
...
- Entering [selection mode](/behaviors/contextual-action-mode) on a list.
...
- [Menu](/atoms/menu)
- [Context menu](/behaviors/context-menu)
