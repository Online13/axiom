...
export default function DialogScreen() {
	...
	return (
		<Screen>
			<Section
				title="Dialog"
				description="Backdrop and Android back close it, unless it isn't dismissible."
			>
				<Panel>
					<Dialog.Root
						onOpenChange={(open) =>
							log(`delete: ${open ? "open" : "closed"}`)
						}
					>
					...
					<Dialog.Root>
						...
						<Dialog.Content dismissible={false}>
							...
							<Dialog.Actions orientation="vertical">
								<Dialog.Action onPress={() => log("saved")}>
									Save
								</Dialog.Action>
								<Dialog.Action
									variant="ghost"
									destructive
									onPress={() => log("discarded")}
								>
									Discard
								</Dialog.Action>
					...
					<Dialog.Root open={signOutOpen} onOpenChange={setSignOutOpen}>
						...
						<Dialog.Content dismissible={!signingOut}>
							...
							<Dialog.Actions>
								<Dialog.Cancel disabled={signingOut}>
									Cancel
								</Dialog.Cancel>
								<Dialog.Action
									closeOnPress={false}
			...
			<Section
				title="Menu"
				description={`Sort: ${sort}. Long press the card, or press the button.`}
			>
				<Panel>
					<View
						style={{
						...
						<Menu.Root>
							...
							<Menu.Content align="end">
								...
								<Menu.Sub label="Share" icon="share">
									<Menu.Item onPress={() => log("copied link")}>
										Copy link
									</Menu.Item>
									<Menu.Item
					...
					<Menu.Trigger>
						<View style={styles.menuTrigger}>
							...
							<Text variant="bodySm" color="muted">
								Long press for options. The card lifts above the
								backdrop.
							</Text>
						</View>
					</Menu.Trigger>
