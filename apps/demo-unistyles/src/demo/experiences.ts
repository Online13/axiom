...
export const EXPERIENCES = [
	...
	},
	{
		...
		description:
			"A bar that gains its background and title as content scrolls under it",
		section: "behaviors",
		group: "Scroll",
		status: "demo",
	},
	...
	},
	{
		...
		description:
			"An action that happens now and can be taken back for a few seconds",
		section: "patterns",
		group: "Patterns",
		status: "demo",
	},
...
export function groupsOfSection(section: ExperienceSection): string[] {
	return [
		...new Set(experiencesOf(section).map((experience) => experience.group)),
	];
}
