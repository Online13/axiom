...
function SwipeRow({
	...
	// The actions take their tone as a prop, not as a style.
		...
		<View style={styles.rowContainer}>
			<View style={styles.actions}>
				<Action
					icon="check"
					label="Read"
					tone={theme.colors.feedback.info}
					onPress={() => act("Read")}
				/>
				...
				<Action
					icon="favorite"
					label="Flag"
					tone={theme.colors.feedback.warning}
					onPress={() => act("Flag")}
				/>
				<Action
					icon="file"
					label="Archive"
					tone={theme.colors.feedback.success}
					onPress={() => act("Archive")}
				/>
			</View>
...
export default function SwipeActionsScreen() {
	...
	const [log, setLog] = useState(
		"Drag a row left for Flag and Archive, right for Read.",
	);
