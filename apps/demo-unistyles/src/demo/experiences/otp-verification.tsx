		...
		<ExperienceScreen>
			<View style={styles.content}>
				<View style={styles.intro}>
					...
					<Text color="muted">
						We sent a six-digit code to +33 6 12 34 56 78. The code for
						this demo is {CODE}.
					</Text>
				</View>
				...
				<View style={styles.code}>
					...
					/>
					{status === "checking" ? (
						<Spinner size="sm" label="Checking the code" />
					) : null}
					{status === "wrong" ? (
				...
				<View style={styles.resend}>
					...
					<Text variant="footnote" color="muted" align="center">
						The cooldown keeps a frustrated user from hammering the
						server. Fifteen seconds here, thirty to sixty in a real app.
					</Text>
				</View>
			</View>
		</ExperienceScreen>
...
const styles = StyleSheet.create((theme) => ({
	...
	intro: { gap: theme.tokens.spacing[2] },
	code: { alignItems: "center", gap: theme.tokens.spacing[3] },
	resend: { gap: theme.tokens.spacing[2], alignItems: "center" },
}));
