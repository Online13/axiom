					...
					<Card variant="outlined" padding={4}>
						<View style={styles.levels}>
							{LEVELS.map((level, index) => (
								<View key={level.title} style={styles.levels}>
					...
					<Card variant="outlined" padding={4}>
						<View style={styles.block}>
							<Text variant="bodySm" color="muted">
								...
								Styling comes from the Unistyles variant; the same demo
								exists for NativeWind, Unistyles and Uniwind.
							</Text>
							<Separator />
							...
							/>
							<Fact label="Styling" value="Unistyles" />
							<Fact
								label="Platform"
...
const styles = StyleSheet.create((theme) => ({
	...
	levels: { gap: theme.tokens.spacing[4] },
	level: { flexDirection: "row", gap: theme.tokens.spacing[3] },
	levelIcon: {
		width: 36,
		height: 36,
