...
| --------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Background, foreground, border, icon, placeholder, track, thumb | Heights, padding, radius, font sizes: read from [tokens](/docs/foundations/tokens) |
| One value per variant and state                                 | Minimum tap target (44pt): [metrics](/docs/foundations/tokens/metrics)             |
|                                                                 | State logic, gestures, animation: [core](/docs/core) and [hooks](/docs/hooks)           |
...
The file exports a pure function of the semantic colors:
...
```ts title="theme/components/button.ts — blue solid buttons" {3-4}
solid: {
  default: {
