...
The hook behind [Swipe actions](/docs/behaviors/swipe-actions). That page explains the direction lock, the resistance, the release rules, the full swipe and accessibility. This one covers the API.
