...
The hook behind [Scroll-aware AppBar](/docs/behaviors/scroll-aware-app-bar). That page explains the elevation, the title handoff and accessibility. This one covers the API.
...
With [AppBar](/docs/templates/app-bar), pass the two values to `elevationProgress` and `titleProgress`:
