...
The hook behind [Hide-on-scroll](/docs/behaviors/hide-on-scroll). That page explains how the bars follow the scroll delta, the snap, and accessibility. This one covers the API.
