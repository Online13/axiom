...
The hook behind [Scroll-to-top](/docs/behaviors/scroll-to-top). That page explains when the button shows, the jump before the animation, the other triggers and accessibility. This one covers the API.
