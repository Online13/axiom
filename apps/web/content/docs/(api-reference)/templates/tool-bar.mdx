	...
	<div class="ax-list" data-variant="plain">
		<div class="ax-item">
			...
			<div class="ax-item-content">
				<span class="ax-item-title">IMG_1842.jpg</span>
				<span class="ax-item-desc">Today, 09:42</span>
			</div>
		</div>
		<div class="ax-item">
			<span class="ax-checkbox" data-state="checked">
			...
			<div class="ax-item-content">
				<span class="ax-item-title">IMG_1839.jpg</span>
				<span class="ax-item-desc">Yesterday, 18:07</span>
			</div>
		</div>
	</div>
	<div class="ax-fill" />
	<div class="ax-toolbar">
		<span class="ax-toolbar-action">
			<Glyph name="share" />
			<span>Share</span>
		</span>
		<span class="ax-toolbar-action">
		...
		<span class="ax-toolbar-action" data-destructive>
			<Glyph name="trash" />
			<span>Delete</span>
		</span>
	</div>
...
Also copies: [`icon`](/docs/atoms/icon), [`text`](/docs/atoms/text) and [`tappable`](/docs/core/tappable). Installs `react-native-reanimated` and `react-native-safe-area-context`.

Colors come from `toolBar.{docked,floating}` and `toolBar.action.{default,selected,destructive,disabled}` in the [component tokens](/docs/foundations/component-tokens).
...
<PhonePreview half="bottom" size="sm">
	...
	<div class="ax-list" data-variant="plain">
		<div class="ax-item">
			...
			<div class="ax-item-content">
				<span class="ax-item-title">Design brief.pdf</span>
				<span class="ax-item-desc">1.8 MB</span>
			</div>
		</div>
		<div class="ax-item">
			<span class="ax-checkbox" data-state="checked">
			...
			<div class="ax-item-content">
				<span class="ax-item-title">Estimate.xlsx</span>
				<span class="ax-item-desc">46 KB</span>
			</div>
		</div>
		<div class="ax-item">
			...
			<div class="ax-item-content">
				...
				<span class="ax-item-desc">12 MB</span>
			</div>
		</div>
	</div>
	<div class="ax-fill" />
...
<PhonePreview half="bottom" size="sm">
	<div class="ax-fill ax-media" data-tone="6">
		<div class="ax-center">
			<Glyph name="image" size={64} />
		</div>
	</div>
	<div class="ax-toolbar" data-variant="floating">
...
<PhonePreview half="bottom" size="sm">
	<div class="ax-appbar">
		...
		<span class="ax-appbar-title">Note</span>
	...
	<div class="ax-body">
		<span class="ax-title3">Monday ideas</span>
		<span class="ax-text">
			Make the empty state useful and keep the next action close to the
			explanation.
		</span>
		<span class="ax-text ax-muted ax-caret">Add a note</span>
	</div>
	<div class="ax-fill" />
	<div class="ax-toolbar">
		<span class="ax-toolbar-action">
		...
		<span class="ax-toolbar-action" data-state="disabled">
			<Glyph name="arrow-up" />
			<span>Move</span>
		</span>
		<span class="ax-toolbar-action">
...
- [Dialog](/docs/atoms/dialog), for destructive confirmations
