...
<PhonePreview>
	<div class="ax-appbar">
		...
		<span class="ax-appbar-title">Help</span>
		<span class="ax-icon-btn">
			<Glyph name="search" />
		</span>
	</div>
	<div class="ax-body" style={{ gap: "0px" }}>
		<span class="ax-title2" style={{ paddingBottom: "8px" }}>
			Frequently asked
		</span>
		<div class="ax-accordion-item">
			<div class="ax-accordion-trigger">
				How long does shipping take?
				<Glyph name="chevron-up" size={20} />
			</div>
			<div class="ax-accordion-content">
				Orders ship within 2 business days. Delivery takes 3–5 days in
				Europe and 5–8 days elsewhere. You'll get a tracking link by email.
			</div>
		</div>
		<div class="ax-accordion-item">
			<div class="ax-accordion-trigger">
				Can I return an item?
				<Glyph name="chevron-down" size={20} />
			</div>
		</div>
		<div class="ax-accordion-item">
			<div class="ax-accordion-trigger">
		...
		<div class="ax-accordion-item">
			<div class="ax-accordion-trigger ax-disabled">
				Gift cards
...
Requires the `chevron-down` icon in your [icon registry](/docs/atoms/icon#icons-that-components-need). Open sections, measuring and the height animation live in `use-accordion.ts`, shared by every styling variant.
...
<PhonePreview size="sm">
	<div class="ax-body" style={{ gap: "0px", paddingTop: "12px" }}>
		...
		<div class="ax-accordion-item">
			...
			<div class="ax-accordion-content">
				Yes. The code is copied into your project and you own it. There is
				no runtime package to pay for.
			</div>
		</div>
		<div class="ax-accordion-item">
			<div class="ax-accordion-trigger">
...
<PhonePreview size="sm">
	<div class="ax-appbar">
		...
		<span class="ax-appbar-title">Order #10482</span>
		<span class="ax-icon-btn" />
	</div>
	<div class="ax-body" style={{ gap: "0px" }}>
		<div class="ax-accordion-item">
			<div class="ax-accordion-trigger">
				<span class="ax-row">
					<Glyph name="bag" size={20} />3 items
				</span>
				<span
					class="ax-row ax-subhead ax-muted"
			...
			<div class="ax-accordion-content ax-stack" data-gap="4">
				<div class="ax-row" data-justify="between">
					<span>Canvas tote × 1</span>
					<span>$32.00</span>
				</div>
				<div class="ax-row" data-justify="between">
...
<PhonePreview half="bottom" size="sm">
	<div class="ax-body" style={{ gap: "12px" }}>
		<div class="ax-field">
			<span class="ax-label">Project name</span>
			<div class="ax-control">
				<span class="ax-value">axiom-demo</span>
			</div>
		</div>
		<div
			class="ax-accordion-item"
			style={{ borderTop: "1px solid var(--ax-border-default)" }}
		>
			<div class="ax-accordion-trigger ax-subhead">
				Advanced
				<Glyph name="chevron-up" size={20} />
			</div>
			<div class="ax-accordion-content ax-stack" data-gap="12">
				<div class="ax-row" data-justify="between">
					<span
						class="ax-text"
				...
				<div class="ax-field">
					<span class="ax-label">Bundle identifier</span>
					<div class="ax-control">
						<span class="ax-value">dev.axiom.demo</span>
					</div>
				</div>
			</div>
		</div>
