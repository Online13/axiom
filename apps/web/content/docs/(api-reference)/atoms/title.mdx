...
Each variant points to a [typography token](/docs/foundations/tokens/typography). Pick the variant from the role of the heading on the screen, not from the size you want.
...
| `asChild`       | `boolean`                                                              | `false`     | Passes the styles to the child instead of rendering a `Text`. See [Slot](/docs/core/slot). |
...
- Font scaling stays on. Use `maxFontSizeMultiplier` to cap it on dense screens, with the caps from [Text](/docs/atoms/text#system-text-size).

## Related

- [Text](/docs/atoms/text)
- [Typography tokens](/docs/foundations/tokens/typography)
