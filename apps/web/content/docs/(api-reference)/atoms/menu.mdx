...
<PhonePreview>
	...
	>
		<span class="ax-media" data-tone="1" style={{ height: "128px" }} />
		<span class="ax-media" data-tone="2" style={{ height: "128px" }} />
		<span class="ax-media" data-tone="3" style={{ height: "128px" }} />
		<span class="ax-media" data-tone="4" style={{ height: "128px" }} />
		<span class="ax-media" data-tone="5" style={{ height: "128px" }} />
		<span class="ax-media" data-tone="6" style={{ height: "128px" }} />
	</div>
	<div
		class="ax-scrim"
		style={{ background: "rgb(0 0 0 / 0.25)", backdropFilter: "blur(6px)" }}
	/>
	<div
		class="ax-layer"
		style={{
	...
	>
		...
		<div class="ax-menu" style={{ width: "230px" }}>
			<span class="ax-menu-item">
				Copy
				<Glyph name="copy" size={20} />
			</span>
			<span class="ax-menu-item" data-state="pressed">
				Share
			...
			<span class="ax-menu-item" data-destructive>
				Delete
...
Also copies: [`portal`](/docs/core/portal), [`overlay`](/docs/core/overlay), `use-overlay-back-handler`, which closes the menu on a back action. See [navigation](/docs/configuration#navigation). And `overlay-stack`: a menu opened from a [BottomSheet](/docs/atoms/bottom-sheet#dialog-and-menu) takes the back action and the touches from the sheet, without scaling it.

Installs: `react-native-reanimated`, `react-native-safe-area-context`, `react-native-worklets`.

Requires the `arrow-left`, `check` and `chevron-right` icons in your [icon registry](/docs/atoms/icon#icons-that-components-need). Positioning and the animation live in `use-menu.ts`. Colors come from `menu.default.{default,pressed,destructive,disabled}` in the [component tokens](/docs/foundations/component-tokens).
...
| `haptic`             | `HapticKind \| false`    | `'medium'` with `longPress` | Haptic played when the menu opens. Nothing by default with `press`. `false` turns it off.                      |
...
A menu opened by a long press plays a `medium` haptic as it opens: it confirms the press was long enough, the way iOS context menus do. A menu opened by a simple press plays nothing. Set `haptic` on `Menu.Trigger` to change the kind, or `false` to turn it off. Nothing plays until your app connects a haptics library: see [Haptics](/docs/integrations/haptics).

## Use cases

### "More" button in an app bar

`action="press"` on an [IconButton](/docs/atoms/icon-button). No preview, the menu hangs from the button.
...
<PhonePreview size="sm">
	<div class="ax-appbar">
		...
		<span class="ax-appbar-title">Q3 planning</span>
		<span class="ax-icon-btn" data-variant="tinted">
			<Glyph name="more" />
		</span>
	</div>
	<div class="ax-body">
		<div class="ax-placeholder-block" style={{ height: "200px" }} />
	</div>
	<div
		class="ax-layer"
		style={{
	...
	>
		<div class="ax-menu" style={{ width: "230px" }}>
			...
			<span class="ax-menu-item" style={{ borderTop: "none" }}>
				Date
				<Glyph name="check" size={20} class="ax-link" />
			</span>
...
<PhonePreview size="sm">
	...
	<div
		class="ax-scrim"
		style={{ background: "rgb(0 0 0 / 0.2)", backdropFilter: "blur(8px)" }}
	/>
	<div
		class="ax-layer"
		style={{
	...
	>
		...
		<div class="ax-menu" style={{ width: "220px" }}>
			<span class="ax-menu-item">
				Reply
...
A long press on a row, as an alternative to [swipe actions](/docs/behaviors/swipe-actions) that is easier to discover.
...
<PhonePreview size="sm">
	<div class="ax-list" data-variant="plain" style={{ paddingTop: "8px" }}>
		<div class="ax-item">
			...
			<span class="ax-item-title ax-grow">Roadmap.pdf</span>
		</div>
	</div>
	<div
		class="ax-scrim"
	...
	>
		...
		>
			...
			<div class="ax-item-content">
				<span class="ax-item-title">Moodboard.png</span>
				<span class="ax-item-desc">4.2 MB</span>
			</div>
		</div>
		<div class="ax-menu">
			<span class="ax-menu-item">
			...
			<span class="ax-menu-item" data-state="disabled">
				Rename
				<Glyph name="edit" size={20} />
			</span>
		</div>
...
- [Long press](/docs/behaviors/long-press), to open it from a row
