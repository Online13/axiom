...
Also copies: [`portal`](/docs/core/portal), [`overlay`](/docs/core/overlay), `use-overlay-back-handler`, which closes the menu on a back action. See [navigation](/docs/configuration#navigation).
