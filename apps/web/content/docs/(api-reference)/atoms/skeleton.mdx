		...
		<div class="ax-stack" data-gap="12">
			<div class="ax-row" data-gap="12">
				...
				<div class="ax-stack ax-grow" data-gap="8">
					<span class="ax-skeleton" style={{ width: "45%" }} />
					<span
						class="ax-skeleton"
			...
			<span
				...
				style={{ height: "150px" }}
			/>
			<span class="ax-skeleton" style={{ width: "90%" }} />
			<span class="ax-skeleton" style={{ width: "70%" }} />
		</div>
		<div class="ax-row" data-gap="12">
			<span
				class="ax-skeleton"
			...
			/>
			<div class="ax-stack ax-grow" data-gap="8">
				<span class="ax-skeleton" style={{ width: "55%" }} />
				<span
					class="ax-skeleton"
...
The shared animation clock lives in `use-skeleton.ts`. Colors come from `skeleton.default.default.{background,highlight}` in the [component tokens](/docs/foundations/component-tokens).
...
| `variant`   | `TextVariant`                    | `'body'`    | Uses the line height of this [Text](/docs/atoms/text) variant, so the placeholder has the same height as the text. |
...
<PhonePreview size="sm">
	...
	<div class="ax-list" data-variant="plain">
		<div class="ax-item">
			...
			/>
			<div class="ax-stack ax-grow" data-gap="8">
				<span class="ax-skeleton" style={{ width: "50%" }} />
				<span
					class="ax-skeleton"
					style={{ width: "32%", height: "12px" }}
				/>
			</div>
		</div>
		<div class="ax-item">
			...
			/>
			<div class="ax-stack ax-grow" data-gap="8">
				<span class="ax-skeleton" style={{ width: "62%" }} />
				<span
					class="ax-skeleton"
					style={{ width: "28%", height: "12px" }}
				/>
			</div>
		</div>
		<div class="ax-item">
			...
			/>
			<div class="ax-stack ax-grow" data-gap="8">
				<span class="ax-skeleton" style={{ width: "44%" }} />
				<span
					class="ax-skeleton"
					style={{ width: "36%", height: "12px" }}
				/>
			</div>
		</div>
		<div class="ax-item">
			...
			/>
			<div class="ax-stack ax-grow" data-gap="8">
				<span class="ax-skeleton" style={{ width: "56%" }} />
				<span
					class="ax-skeleton"
					style={{ width: "24%", height: "12px" }}
				/>
			</div>
		</div>
	</div>
...
<PhonePreview size="sm">
	...
	<div class="ax-body" style={{ gap: "12px" }}>
		...
		<span
			...
			style={{ height: "130px" }}
		/>
		<span class="ax-skeleton" />
		<span class="ax-skeleton" />
		<span class="ax-skeleton" style={{ width: "65%" }} />
	</div>
</PhonePreview>
	...
	>
		<div class="ax-stack" data-gap="8">
			<span
				...
				style={{ height: "150px" }}
			/>
			<span class="ax-skeleton" style={{ width: "80%" }} />
			<span class="ax-skeleton" style={{ width: "35%" }} />
		</div>
		<div class="ax-stack" data-gap="8">
			<span
				class="ax-skeleton"
			...
			/>
			<span class="ax-skeleton" style={{ width: "70%" }} />
			<span class="ax-skeleton" style={{ width: "40%" }} />
		</div>
	</div>
</PhonePreview>
