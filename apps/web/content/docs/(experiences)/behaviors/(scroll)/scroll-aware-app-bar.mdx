...
<Callout title="Draft">
	...
	[useScrollAwareAppBar](/docs/hooks/use-scroll-aware-app-bar) and may change.
</Callout>
...
| [Collapsible header](/docs/behaviors/collapsible-header) | changes its height               | position |
| [Hide-on-scroll](/docs/behaviors/hide-on-scroll)         | leaves the screen                | delta    |
...
Axiom implements it with one hook, [`useScrollAwareAppBar`](/docs/hooks/use-scroll-aware-app-bar), and two [AppBar](/docs/templates/app-bar) props that read its values.
...
Installation, options and return value are documented in [useScrollAwareAppBar](/docs/hooks/use-scroll-aware-app-bar).
...
- [useScrollAwareAppBar](/docs/hooks/use-scroll-aware-app-bar)
