...
<Callout title="Draft">
	...
	[useScrollToTop](/docs/hooks/use-scroll-to-top) and may change.
</Callout>
...
- Lists that load more pages as the user scrolls ([pagination](/docs/behaviors/pagination)).
...
Axiom implements it with one hook, [`useScrollToTop`](/docs/hooks/use-scroll-to-top). It tracks the offset and exposes `visible` and `scrollToTop()`. The button is yours.
...
Installation, options and return value are documented in [useScrollToTop](/docs/hooks/use-scroll-to-top).
...
- [useScrollToTop](/docs/hooks/use-scroll-to-top)
