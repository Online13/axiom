...
<Callout title="Draft">
	...
	[InputOTP](/docs/atoms/input-otp). The API may change.
</Callout>
...
- Confirm with a [Toast](/docs/atoms/toast) ("New code sent"), since nothing else on screen changes.
...
| Library                                                    | Used for                                              |
| ---------------------------------------------------------- | ----------------------------------------------------- |
| [InputOTP](/docs/atoms/input-otp)                               | The cells, paste handling and `onComplete`.           |
