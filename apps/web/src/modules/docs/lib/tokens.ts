...
export const colorRoles = {
	background: {
		...
		subtle: {
			usage: "Grouped lists, secondary areas",
			light: "gray.50",
			dark: "gray.950",
		},
		elevated: {
			usage: "Cards, sheets, dialogs, menus",
			light: "hsla(0, 0%, 100%, 1)",
			dark: "gray.900",
		},
		inverse: {
			usage: "Toasts, snackbars, tooltips",
			light: "gray.950",
			dark: "gray.50",
		},
	},
	content: {
		default: {
			usage: "Titles and body text, icons",
			light: "gray.950",
			dark: "gray.50",
		},
		muted: {
		...
		disabled: {
			usage: "Disabled labels and icons",
			light: "gray.300",
			dark: "gray.700",
		},
		inverse: {
	...
	border: {
		default: {
			usage: "Inputs, cards, separators",
			light: "gray.200",
			dark: "gray.800",
		},
		subtle: {
			usage: "Dividers inside a surface",
			light: "gray.100",
			dark: "gray.900",
		},
		strong: {
			usage: "Unchecked checkboxes and radios",
			light: "gray.400",
			dark: "gray.600",
		},
		focus: {
	...
	feedback: {
		info: {
			usage: "Informative icon, text or fill",
			light: "blue.500",
			dark: "blue.400",
		},
		infoSubtle: {
			usage: "Informative alert background",
			light: "blue.50",
			dark: "blue.950",
		},
		success: {
			usage: "Confirmation icon, text or fill",
			light: "green.500",
			dark: "green.400",
		},
		successSubtle: {
		...
		warning: {
			usage: "Warning icon, text or fill",
			light: "orange.500",
			dark: "orange.400",
		},
		warningSubtle: {
		...
		error: {
			usage: "Error icon, text, destructive action",
			light: "red.500",
			dark: "red.400",
		},
		errorSubtle: {
...
export function roleColor<R extends ColorRole>(
	scheme: ColorScheme,
	role: R,
	key: keyof (typeof colorRoles)[R],
): string {
...
export const componentTokens = {
	...
	badge: {
		...
		info: {
			default: {
				background: "feedback.infoSubtle",
				foreground: "feedback.info",
			},
		},
		success: {
			default: {
		...
		warning: {
			default: {
				background: "feedback.warningSubtle",
		...
		error: {
			default: {
				background: "feedback.errorSubtle",
				foreground: "feedback.error",
			},
		},
		outline: {
			default: { foreground: "content.default", border: "border.default" },
		},
		inverse: {
			default: {
	...
	avatar: {
		...
		status: {
			default: {
				...
				away: "feedback.warning",
				busy: "feedback.error",
				offline: "content.subtle",
			},
		},
	},
	chip: {
	...
	card: {
		elevated: {
			default: { background: "background.elevated" },
			pressed: { background: "background.subtle" },
		},
		outlined: {
			default: {
		...
		filled: {
			default: { background: "background.subtle" },
			pressed: { background: "border.subtle" },
		},
	},
	item: {
		default: {
	...
	alert: {
		info: {
			default: { background: "feedback.infoSubtle", icon: "feedback.info" },
		},
		success: {
			default: {
				background: "feedback.successSubtle",
	...
	empty: {
		neutral: {
			default: { media: "background.subtle", icon: "content.muted" },
		},
		error: {
			default: { media: "feedback.errorSubtle", icon: "feedback.error" },
		},
	},
	toast: {
		default: {
...
export function flattenComponent(name: ComponentName) {
	return Object.entries(
		componentTokens[name] as Record<string, ComponentStates>,
